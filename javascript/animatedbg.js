// code for animated canvas background
// import * as THREE from 'https://cdn.skypack.dev/three@v0.122.0';
import * as THREE from '../utils/three/build/three.module.js';
...
if (false) {
    document.body.style.background = "url(\"../utils/mobilebg.png\")"
}
else {
    document.addEventListener("DOMContentLoaded", function (e) {
        ...
        let material = new THREE.ShaderMaterial({
            uniforms: {
                u_bg: { type: 'v3', value: rgb(5, 24, 57) },
                u_bgMain: { type: 'v3', value: rgb(22, 75, 96) },
                u_color1: { type: 'v3', value: rgb(85, 50, 153) },
                u_color2: { type: 'v3', value: rgb(20, 196, 219) },
